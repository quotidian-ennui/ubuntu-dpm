...
UPDATECLI_TEMPLATE=${UPDATECLI_TEMPLATE:-$ROOT/src/main/resources/updatecli.yml}
UPDATECLI_ARCHIVE_TEMPLATE=${UPDATECLI_ARCHIVE_TEMPLATE:-$ROOT/src/main/resources/archive-updatecli.yml}
